...
public class Custom {
    ...
    public boolean equals(Object o) {
        ...
        if (id != custom.id)
            return false;
        if (customName != null ? !customName.equals(custom.customName) : custom.customName != null)
            return false;
        if (customNameEncrypted != null ? !customNameEncrypted.equals(custom.customNameEncrypted) : custom.customNameEncrypted != null)
            return false;
        if (password != null ? !password.equals(custom.password) : custom.password != null)
            return false;
        if (updateTime != null ? !updateTime.equals(custom.updateTime) : custom.updateTime != null)
            return false;
        if (createTime != null ? !createTime.equals(custom.createTime) : custom.createTime != null)
            return false;
        ...
        if (customPhoneNumber != null ? !customPhoneNumber.equals(custom.customPhoneNumber) : custom.customPhoneNumber != null)
            return false;
        if (customEmail != null ? !customEmail.equals(custom.customEmail) : custom.customEmail != null)
            return false;
